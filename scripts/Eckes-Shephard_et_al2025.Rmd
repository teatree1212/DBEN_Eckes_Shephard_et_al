...
png(file=paste0(Figs_dir,simdate,"/Figure_5.png"),width=80,height=80,units="mm",res =1000)
...
png(filename=paste0(Figs_dir,simdate,"/Figure_2.png"),width=80,height=120,units = "mm",res=1000)
  ...
  if(site=="BCI"){
    ...
    legend(legend = c("BiomeE","BiomeEP","CABLE-POP","FATES","JULES-RED","LPJ-GUESS","EDv3","SEIB-DGVM","ORCHIDEE"),
         ...
         col = c(get_model_colour("BiomeE-Standalone"),
                 ...
                 get_model_colour("EDv3"),
                 get_model_colour("SEIB-DGVM"),
                 get_model_colour("ORCHIDEE")),"bottomright", ncol = 2, box.lwd = 0)
